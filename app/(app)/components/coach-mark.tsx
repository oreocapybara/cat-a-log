...
export function CoachMark({
  ...
  return (
    ...
    >
      {arrow === 'top' && (
        <div className="border-x-8 border-b-8 border-x-transparent border-b-primary h-0 w-0" />
      )}
      ...
      {arrow === 'bottom' && (
        <div className="border-x-8 border-t-8 border-x-transparent border-t-primary h-0 w-0" />
      )}
    </div>
  )
}
