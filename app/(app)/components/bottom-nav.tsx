...
export default function BottomNav() {
  ...
  return (
    <nav className="bg-card/70 dark:bg-card/90 fixed inset-x-4 bottom-4 z-50 rounded-full border border-white/40 shadow-lg backdrop-blur-md transition-[background-color,border-color,box-shadow] duration-100 dark:border-white/10">
