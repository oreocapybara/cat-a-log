 ...
 * (search bar, filter button, user dot) so there's no layout shift when the
 * real map appears. Kept deliberately quiet — only the background and status
 * text pulse; individual element skeletons stay static so the eye rests.
 */
export function MapSkeleton() {
  return (
    <div className="relative -mb-28 h-screen overflow-hidden bg-neutral-100 dark:bg-neutral-900">
      ...
      {/* Locate button placeholder (static) */}
